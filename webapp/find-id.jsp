...
<body class="animsition">
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92"
		...
		<h2 class="ltext-105 cl0 txt-center">ID 찾기</h2>
	</section>
		...
		<div id="contentWrap" class="container">
			<div class="bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg">
				...
				<form action="findId.do" method="post">
					<h4 class="mtext-105 cl2 txt-left">정보입력</h4>
					<p class="fs-11">가입된 정보와 동일하다면 ID를 문자로 발송해드립니다.</p>
					<hr class="m-b-60">
					...
					<table class="bor8 m-b-40">
						<tr>
							...
							<td><input
								...
								type="text" name="uname" placeholder="이름입력" required></td>
						</tr>
						<tr>
